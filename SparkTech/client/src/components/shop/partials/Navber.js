...
const Navber = (props) => {
  ...
  return (
    <Fragment>
      {/* Navber Section */}
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none">
        <div className="m-4 md:mx-3 md:my-2 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-900 mt-3">
            <span
              className="px-4 py-3 rounded-lg  font-light font-extrabold tracking-widest hover:text-gray-800 cursor-pointer"
            ...
            {/* <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light font-extrabold tracking-widest hover:text-gray-800 cursor-pointer"
          ...
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            ...
            {/* <span
              ...
              className="flex items-left text-center font-extrabold   text-2xl cursor-pointer px-2 text-center">
              SparkTech
            </span> */}
          </div>
          <div
            onClick={(e) => history.push("/")}
            style={{ color: "white", fontFamily: "Zen Tokyo Zoo", fontSize:"35px"}}
            className="hidden lg:block flex items-left col-span-1 text-center tracking-widest text-3xl cursor-pointer">
            Sparktech
          </div>
          <div className="flex items-right col-span-2 lg:col-span-1 flex justify-end">
              ...
              <svg
                className={`${
                  location.pathname === "/wish-list"
                    ? "fill-current text-800"
                    : ""
                } w-8 h-8 text-600 cursor-pointer`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
            ...
            {localStorage.getItem("jwt") ? (
              <Fragment>
                ...
                >
                  <svg
                    className="cursor-pointer w-8 h-8 text-600 hover:text-gray-800"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="userDropdown absolute right-0 mt-1 bg-gray-200 rounded">
                    {!isAdmin() ? (
                      <Fragment>
                        <li className="flex flex-col text-700 w-48 shadow-lg">
                          <span
            ...
            >
              <svg
                className="w-8 h-8 text-600 hover:text-gray-800"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
